...
namespace EM.Repository
{
    public class RepositorioAluno : RepositorioAbstrato<Aluno>
    {
        public bool ProcureCpfJaCadastrado(string cpf, int matricula) => 
            Get(aluno => aluno.Cpf == cpf && aluno.Matricula != matricula).FirstOrDefault() != null;           
        public bool ProcureMatriculaJaCadastrada(int matricula) => 
            BusqueAlunosPorMatricula(matricula) != null;
    ...
    aluno.Nascimento.ToString("MM/dd/yyyy") + "','" + Convert.ToInt64(aluno.Sexo) + "')";
        ...
        public bool EntrarNoSistemaComoAluno(string nome, string senha) => 
            Get(alun => alun.Nome.ToLower() == nome.ToLower() && alun.Cpf == senha).First() != null;      
